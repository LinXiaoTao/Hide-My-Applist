...
import com.box.android.black.common.BuildConfig
...
object UserService {
    ...
    private const val TAG = "Black-UserService"
    ...
    private val uidObserver = object : UidObserverAdapter() {
        override fun onUidActive(uid: Int) {
            ...
            try {
                ...
                val extras = Bundle()
                extras.putBinder("binder", BlackService.instance)
