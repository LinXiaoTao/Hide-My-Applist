...
import com.box.android.black.common.JsonConfig
import com.box.android.black.plugin.hook.IFrameworkHook
import com.box.android.black.plugin.hook.PlatformCompatHook
import com.box.android.black.plugin.hook.PmsHookLegacy
import com.box.android.black.plugin.hook.PmsHookTarget28
import com.box.android.black.plugin.hook.PmsHookTarget30
import com.box.android.black.plugin.hook.PmsHookTarget33
import com.box.android.black.common.*
import java.io.File

class BlackService(val pms: IPackageManager) : IBlackService.Stub() {

    companion object {
        private const val TAG = "Black-Service"
        var instance: BlackService? = null
    }
    ...
    init {
        ...
        loadConfig()
        installHooks()
        logI(TAG, "Black service initialized")
    }
    ...
    private fun searchDataDir() {
        ...
        if (!this::dataDir.isInitialized) {
            dataDir = "/data/misc/black_applist_" + Utils.generateRandomString(16)
        }
